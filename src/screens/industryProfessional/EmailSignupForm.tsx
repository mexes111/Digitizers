...
interface ProfEmailSignupFormProps {
  navigation?: any;
}

export default function ProfEmailSignupForm({ navigation }: ProfEmailSignupFormProps) {
  ...
  const handleContinue = () => {
    if (email.trim() && isValidEmail(email)) {
      (navigation || nav).navigate('ProfVerifyOTP');
    }
  };
