...
export default function AddYourTrack({ navigation }: AddYourTrackProps) {
    ...
    <ScreenContainer>
      ...
      <View style={styles.backgroundContainer}>
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
         ...
         <Typography style={styles.sectionTitle}>Upload your best track sample (max 60 seconds). Choose the part that best represents your sound.</Typography>
         {!audio && 
         <TouchableOpacity onPress={handleUpload}>
         <Image resizeMode='contain' style={{height: 80, width: 320}} source={require('../../assets/audioupload.png')}/>
         </TouchableOpacity>
         }
         {audio &&
          ...
          <View style={styles.uploadSection}>
            {/* Sample uploaded image */}
              ...
              <View style={styles.uploadSection1}>
            <Image resizeMode='contain' style={{height: 80, width: 80, marginRight:15}} source={require('../../assets/audio.png')}/>
            <Image resizeMode='contain' style={{height: 80, width: 80, marginRight: 15}} source={require('../../assets/add.png')}/>
            <Image resizeMode='contain' style={{height: 80, width: 80}} source={require('../../assets/add.png')}/>
           </View>
            ...
            <View style={styles.inputContainer}>
              <TextInput
                ...
                placeholder="Similar artist eg Burna boy"
                placeholderTextColor="#666666"
              />
            </View>
